...
export const Academics = () => {
  ...
  const handleAcademicsDetails = (Academics) => {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (record) => (
        <div>
          <Tooltip title="View">
            <FolderViewOutlined onClick={() => handleAcademicsDetails(record)} />
          </Tooltip>
  ...
  return (
    <Academicsstyle>
      <AcademicTable>
        <div className="title ">Academics certificate</div>
        {/* <div className="">
          <Button onClick={handleAddAcademics}>
