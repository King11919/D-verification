...
export const AddNewStudents = ({ isUpdating = false }) => {
  ...
  return (
    <CompanyForm>
      <div className="form-title">
        {isUpdating ? "Edit" : "Enter New"} Courses Detailss
      </div>
      ...
      >
        ...
        >
          <Input placeholder="Enter Student ID to Enroll" />
        </Form.Item>
        ...
        <div class="form-check">
          ...
          <label class="form-check-label" for="flexCheckDefault">
            All entered data have been cross verifieds
          </label>
        </div>
