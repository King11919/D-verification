...
import { Certificates, TableHeader, CustomModal } from "../Student/styles";

export const CertificatesLst = ({
    certificateList = [],
    setCertificateList,
    employeeId = "",
}) => {
    ...
    const handleIssueCertificate = () => {
        ...
        // student?module=home&view=newcertificate#
        // institute/home?module=student&view=list#
        // institute/home?module=courses&view=list#
        navigate(`institute/home?module=student&view=list#`);
    };
    ...
    return (
        <Certificates>
            <TableHeader>
                ...
                <div className="actions" style={{ display: 'flex', float: 'right', }}>
                    <Button onClick={handleIssueCertificate}>
                        <IdcardFilled /> Add new certificate
...
export default CertificatesLst;
