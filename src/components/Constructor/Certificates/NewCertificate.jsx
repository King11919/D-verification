...
export const Newcertificateconstructor = () => {
      ...
      render: (record) => {
        ...
        return (
          <div>
            ...
            <Button  className={isVerified && "grey-out"}
                onClick={() => handleCertificateVerify(record, isVerified)}>
           <FileSearchOutlined />  Verify
          </Button>
  ...
  return (
    <Certificates>
      <TableHeader>
        <div className="title">Recent Certificates</div>
        <div className="actions">

       

          <Button onClick={handleIssueCertificate}>
          <FileSearchOutlined /> Auto Verify
          </Button>
        </div>
      </TableHeader>
      <Table
...
export default Newcertificateconstructor;
