...
import { TwitterSquareFilled, StarFilled, StarTwoTone } from '@ant-design/icons';
import {
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="card-body text-primary">
                ...
                <div className="description fs-4">{companyDetails.description}</div>
...
<div class="list-inline">
  <li class="list-inline-item"><div className="accounts">
  ...
  <li class="list-inline-item "  style={{ color: "blue" }}>  
        ...
        <div class="col-sm-5 ">
          <div class="card " style={{ width: "17rem", justifyContent: 'center', display: 'flex', textAlign: 'center' }}>
            <div className="logo mt-4 ">
              <Image width={210} src={companyDetails.logoUrl} />
            </div>
            <div class="card-body">
              <h5 class="card-title"> <div className="name">{companyDetails.name}</div></h5>

            </div>
            <ul class="list-group list-group-flush">
              <li class="list-group-item"> <div className="orgID fs-6 text-success">#{companyDetails.uniqueId}</div></li>
